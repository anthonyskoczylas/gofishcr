...
def charters():
    ...
    body = page_hero(r, 'Fishing charters in Tamarindo &amp; Flamingo', 'From 21-foot center consoles to 43-foot sport fishers and private catamarans. Rates are per boat, all gear and drinks included. Pick a base, tell us your group, and we will tell you which boat is right.', '43_-riviera-pics3-side-view.jpg', [('Home', r+'index.html'), ('Charters', None)]) + f'''
...
def adventures():
    r = '../'
    body = page_hero(r, 'Adventures in Guanacaste', 'Fishing holds a special place in our hearts, but the Gold Coast has more to give. Sixteen tours we have personally done, with guides and operators we trust. Pickup in Tamarindo or Flamingo on most.', 'zipline-tour.jpg', [('Home', r+'index.html'), ('Adventures', None)]) + f'''
